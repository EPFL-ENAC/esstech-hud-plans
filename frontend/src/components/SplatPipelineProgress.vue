...
<template>
    <div class="pipeline-results">
        ...
        <div class="q-pa-md">
            ...
            <q-linear-progress :value="props.value.progress" :color="statusColor" size="10px" class="q-mb-xl" />
        </div>
                ...
                <div class="q-mt-sm">
                    <q-item clickable v-ripple>
                        ...
                        <q-item-section>
                            ...
                            <q-item-label caption><div class="path">{{ props.value.output.splat_path }}</div></q-item-label>
                        </q-item-section>
                    </q-item>
                </div>
            </q-card-section>
