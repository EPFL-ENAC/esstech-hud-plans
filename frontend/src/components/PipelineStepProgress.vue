    ...
    >
        <div class="q-pa-md q-gutter-y-sm">
            ...
            <div v-if="step.command" class="relative-position q-mt-md">
                ...
                <pre class="bg-grey-2 q-pa-sm rounded-borders scroll-x q-mt-xs">{{ commandString.trim() }}</pre>
            </div>
            ...
            <div class="relative-position q-mt-md">
                ...
                <div
                    ref="logsContainer"
                    :class="['logs-container bg-black text-white q-pa-sm rounded-borders', { 'scroll-x': !wrapLogs }]"
